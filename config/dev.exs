...
config :desafio_tecnico, DesafioTecnicoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yyDkEwF2DMS15QdBc48XqJglA9/LLekAkS0hhTVRS5zBtRZzDIAOvu2snVEkYO/9",
  watchers: [
...
config :desafio_tecnico, DesafioTecnicoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/desafio_tecnico_web/router\.ex$"E,
      ~r"lib/desafio_tecnico_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :desafio_tecnico, dev_routes: true
